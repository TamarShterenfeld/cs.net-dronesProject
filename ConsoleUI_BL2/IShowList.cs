...
namespace ConsoleUI_BL
{
   ...
   /// </summary>
    public interface IShowList
    {
        ...
        static void ShowList(IEnumerable<BaseStationForList> baseStations) { }
        ...
        static void  ShowList(IEnumerable<DroneForList> drones) { }
        ...
        static void ShowList(IEnumerable<ParcelForList> parcels) { }
        ...
        static void ShowList(IEnumerable<CustomerForList> customers) { }
